...
There are diverse groups in Lebanon that can affect the age distribution of voters. This is due to the dynamics of the 1975 Lebanese Civil War. We propose to create a Shiny App to show a comparison of these groups.
...
```{r fig.height = 6, fig.width=10, fig.align = 'center', message = F}
require(ggplot2)
